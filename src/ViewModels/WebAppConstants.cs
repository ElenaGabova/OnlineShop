namespace OnlineShopWebApp.Constants
{
    public static class WebAppConstants
    {
        ...
        public const string RequiredDirectionName = "Не указано название напрапвления!";
        public const string RequiredDirectionDescription = "Не указано описание напрапвления!";
        public const string RequiredDirectionMainImage = "Не указано Фото напрпавления!";
    }
}
